...
const FeedCard = ({user}) => {
    const {firstName, lastName, skills, gender, age, photoUrl, about} = user;
  return (
     <div className=" flex items-center justify-center bg-[#e0e5ec] mt-[60px]">
      <div className="bg-[#e0e5ec] rounded-2xl shadow-[10px_10px_20px_#a3b1c6,-10px_-10px_20px_#ffffff]  w-70 h-100 text-center">
